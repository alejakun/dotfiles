  ...
  for zone, idx in zones
    ...
    if zone != ''
      ...
      if idx < zones.length - 2
        timeHTML = timeHTML + "<div class='Wrapper'><div class='Timezone'>" + values[0] + "</div><div class='Time'>" + values[1] + "</div>" + "<div class='Time'>" + values[2] + "</div></div>"   
             
      else
        timeHTML = timeHTML + "<div class='LastWrapper'><div class='Timezone'>" + values[0] + "</div><div class='Time'>" + values[1] + "</div>" + "<div class='Time'>" + values[2] + "</div></div>"   
