...
const cities = [
  ...
  { name: "San Fransisco", timezone: "America/Los_Angeles" },
    ...
    return (
      <div className={container}>
        ...
        <div className={rightItem}>
          {padZero(ampmHours(date.getHours()), 2)}:{padZero(date.getMinutes(), 2)} {ampm(date.getHours())} {timeIcon(date.getHours())}
        </div>
      </div>
    );
  });
...
const timeIcon = (hours) => {
  return hours >= 6 && hours <= 19 ? "☀️" : "🌙"; 
}
